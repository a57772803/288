...
{
    //20181217 ---棋
    public class MailcenterManageViewModel
    {
        public List<MemberMailCenterMessageListViewModel> listMemberMailCenterMessageListViewModel { get; set; }
        ...
        public long MailCount { get; set; }     //未讀訊息總數
    }
}